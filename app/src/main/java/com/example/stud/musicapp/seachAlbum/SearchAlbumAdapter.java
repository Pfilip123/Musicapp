...
public class SearchAlbumActivity extends AppCompatActivity {
    ...
    private void sortBySales() {Collections. sort (albums, new Comparator<SearchAlbum>() {
        @Override
        public int compare(SearchAlbum album1, SearchAlbum album2) {
    ...
    private void sortByScore() {Collections. sort ( albums , new Comparator<SearchAlbum>() {
        @Override
        public int compare(SearchAlbum album1, SearchAlbum album2) {
